...
<section class="py-5" style="background-color: #f8f9fa;">
  <div class="container mt-4">
    ...
    <div class="card shadow-sm border-0 p-4">
      ...
      <h4 class="fw-semibold mt-4 mb-3">3. Purpose of Collection</h4>
      <ul>
        <li>Personal details: to verify identity and manage bookings</li>
        <li>Booking information: to organize and confirm reservations</li>
        <li>Payment details: to process and verify payments securely</li>
        <li>Website usage data: to improve website functionality and user experience</li>
      </ul>

      <h4 class="fw-semibold mt-4 mb-3">4. How We Use Your Information</h4>
      <ul>
      ...
      <h4 class="fw-semibold mt-4 mb-3">5. Data Protection & Security Measures</h4>
      <p>
      ...
      <h4 class="fw-semibold mt-4 mb-3">6. Cookies and Tracking</h4>
      <p>
        Our website uses cookies to improve user experience and for internal analytics. 
        Cookies help us remember your preferences and sessions. 
        No personal data is shared with third parties. You can manage or disable cookies through your browser settings.
      </p>

      <h4 class="fw-semibold mt-4 mb-3">7. Data Retention</h4>
      <p>
        We retain your personal information for as long as necessary to provide our services 
        and comply with legal obligations. Inactive accounts or old booking data may be archived 
        or deleted periodically to ensure security and privacy.
      </p>

      <h4 class="fw-semibold mt-4 mb-3">8. Sharing of Information</h4>
      <p>
      ...
      <p>
        ...
        with the updated date. Please review it regularly.
      </p>

      <h4 class="fw-semibold mt-4 mb-3">11. Contact Us</h4>
      <p>
